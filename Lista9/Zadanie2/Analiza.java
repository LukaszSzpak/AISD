...
public class Analiza {
	...
	public void wyswietl() {
		System.out.println("Œrednia sprawdzeñ trafionych: " + this.sprawdzenTrafionych*1.00 / this.liczbaTrafionych*1.00);
		System.out.println("Œrednia sprawdzeñ chybionych: " + this.sprawdzenChybionych*1.00 / this.liczbaChybionych*1.00);
		System.out.println("£aczna liczba sprawdzeñ: " + (this.sprawdzenChybionych + this.sprawdzenTrafionych) * 1.00 / 
